...
# bash setup_secrets.sh --app-name azero-streamer-two --project-name router-mainnet-api --region asia-south1 --kube-cluster mainnet-tools --kube-namespace azero-streamer
