...
import { ContractAbi } from '../contract-info/dapp';
import QueryMethods from '../query/dapp';
import BuildExtrinsicMethods from '../build-extrinsic/dapp';
import TxSignAndSendMethods from '../tx-sign-and-send/dapp';
import MixedMethods from '../mixed-methods/dapp';
import EventsClass from '../events/dapp';
