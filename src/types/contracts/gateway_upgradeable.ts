...
import { ContractAbi } from '../contract-info/gateway_upgradeable';
import QueryMethods from '../query/gateway_upgradeable';
import BuildExtrinsicMethods from '../build-extrinsic/gateway_upgradeable';
import TxSignAndSendMethods from '../tx-sign-and-send/gateway_upgradeable';
import MixedMethods from '../mixed-methods/gateway_upgradeable';
import EventsClass from '../events/gateway_upgradeable';
