...
import { ContractAbi } from '../contract-info/gateway_contract';
import QueryMethods from '../query/gateway_contract';
import BuildExtrinsicMethods from '../build-extrinsic/gateway_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/gateway_contract';
import MixedMethods from '../mixed-methods/gateway_contract';
import EventsClass from '../events/gateway_contract';
