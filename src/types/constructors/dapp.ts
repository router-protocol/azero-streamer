...
import { ContractFile } from '../contract-info/dapp';
...
export default class Constructors {
	...
	* @param { ArgumentTypes.AccountId } gatewayContractAddress,
	*/
   	async "new" (
		chainId: string,
		gatewayContractAddress: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, chainId, gatewayContractAddress);
			let response;
