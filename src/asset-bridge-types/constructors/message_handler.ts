...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } assetBridgeAddress,
	*/
   	async "new" (
		assetBridgeAddress: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, assetBridgeAddress);
			let response;
