...
import { ContractFile } from '../contract-info/message_handler';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } assetForwarderAddress,
	*/
   	async "new" (
		assetForwarderAddress: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, assetForwarderAddress);
			let response;
