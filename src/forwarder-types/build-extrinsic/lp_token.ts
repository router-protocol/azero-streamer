...
import type * as ArgumentTypes from '../types-arguments/lp_token';
...
export default class Methods {
	...
	*/
	"mint" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "psp22Mintable::mint", [to, value], __options);
	}
	...
	*/
	"burn" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "psp22Burnable::burn", [value], __options);
	}
	...
	*/
	"burnFrom" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "psp22Burnable::burnFrom", [from, value], __options);
	}
