...
import { ContractAbi } from '../contract-info/message_handler';
import QueryMethods from '../query/message_handler';
import BuildExtrinsicMethods from '../build-extrinsic/message_handler';
import TxSignAndSendMethods from '../tx-sign-and-send/message_handler';
import MixedMethods from '../mixed-methods/message_handler';
import EventsClass from '../events/message_handler';
