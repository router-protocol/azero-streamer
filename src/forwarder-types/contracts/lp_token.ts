...
import { ContractAbi } from '../contract-info/lp_token';
import QueryMethods from '../query/lp_token';
import BuildExtrinsicMethods from '../build-extrinsic/lp_token';
import TxSignAndSendMethods from '../tx-sign-and-send/lp_token';
import MixedMethods from '../mixed-methods/lp_token';
import EventsClass from '../events/lp_token';
