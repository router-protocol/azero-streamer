...
import { ContractAbi } from '../contract-info/token';
import QueryMethods from '../query/token';
import BuildExtrinsicMethods from '../build-extrinsic/token';
import TxSignAndSendMethods from '../tx-sign-and-send/token';
import MixedMethods from '../mixed-methods/token';
import EventsClass from '../events/token';
