...
import { ContractAbi } from '../contract-info/asset_forwarder';
import QueryMethods from '../query/asset_forwarder';
import BuildExtrinsicMethods from '../build-extrinsic/asset_forwarder';
import TxSignAndSendMethods from '../tx-sign-and-send/asset_forwarder';
import MixedMethods from '../mixed-methods/asset_forwarder';
import EventsClass from '../events/asset_forwarder';
